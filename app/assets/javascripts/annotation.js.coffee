...
# Creates annotation in db after user hits submit
  $("#image-area").on "click", "#submit", (e) ->
    ...
    if annotation_text != ""
      ...
      $('.annotation-list').append("<li class='#{annotation_count}'>#{annotation_count}. '#{annotation_text}'<br/><a href='#' id='#{annotation_count}' class='#{annotation_count}'>Reply </a> | <a id='delete' class='#{annotation_count}' href='#'>Delete</a></li>")
